...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		//this.load.tilemap('map', 'assets/tiles/newMap.json', null, Phaser.Tilemap.TILED_JSON);
		//this.load.image('tiles', 'assets/tilemaps/tiles/grass_main_128x128_0.png');

		//this.game.load.spritesheet('player', 'assets/chickenTrump.png', 38, 48);
		 this.game.load.tilemap('tilemap', 'asssets/tiles/trumpMap.json', null, Phaser.Tilemap.TILED_JSON);
	    this.game.load.image('tiles', 'assets/tiles/grass_main_128x128_0.png');
	    this.game.load.spritesheet('chickenTrump', 'assets/spritesheet/chickenTrump.png', 70, 100);
	},
